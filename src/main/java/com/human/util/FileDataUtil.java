...
public class FileDataUtil {
	...
	}; // <- 현재 코드는 활용하지 않음, 선언을 한 것이지 기능이 동작하지는 않음, 절대 미리 예측 금지
	...
	@ResponseBody // 어떤 데이터를 포함하여 전송, 어노테이션, View를 지정하지 않고 바로 클라이언트 요청으로 응답함
...
//				String[] files = new String[] { saveName }; // 형변환 files[0] 파일명이 들어감
